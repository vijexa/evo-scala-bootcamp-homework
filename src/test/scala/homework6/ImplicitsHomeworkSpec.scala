...
import homework6.ImplicitsHomework.SuperVipCollections4s._
import homework6.ImplicitsHomework.SuperVipCollections4s.syntax._
import homework6.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import homework6.ImplicitsHomework.SuperVipCollections4s._
          |import homework6.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import homework6.ImplicitsHomework.MyTwitter._
