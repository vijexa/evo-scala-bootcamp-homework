 ...
 */
class Homework8Spec extends AnyWordSpec with Matchers with EitherValues {
  import Homework8Spec._
...
object Homework8Spec {
  implicit val localDateDecoder: Decoder[LocalDate] = Decoder.decodeString emap (
